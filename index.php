...
<section>
    ...
    <div class="grid">
        <!-- Card 1 -->
        <div class="card">
            <img src="dish_1.png" alt="Seared Scallops" class="card-img" onerror="this.src='https://images.unsplash.com/photo-1544025162-8315ea07525b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'">
        ...
        <!-- Card 2 -->
        <div class="card">
            <img src="dish_2.png" alt="Wagyu Beef Filet" class="card-img" onerror="this.src='https://images.unsplash.com/photo-1558030006-450675393462?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'">
            <div class="card-content">
        ...
        <!-- Card 3 -->
        <div class="card">
            <img src="dish_3.png" alt="Chocolate Dome" class="card-img" onerror="this.src='https://images.unsplash.com/photo-1563805042-7684c8a9e9cb?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80'">
            <div class="card-content">
